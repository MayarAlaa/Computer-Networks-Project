...
public class PkPirate_GUI{
  ...
  JRadioButton RB_Port_AD = new JRadioButton("AD(443)");
  JRadioButton RB_Port_SQL = new JRadioButton("SQL(119)");
  JRadioButton RB_Port_LDAP = new JRadioButton("LDAP(389)");
  
  JLabel L_Title = new JLabel("PacketPirate v1.0"); 
  JLabel L_Interface = new JLabel("Interface"); 
  JLabel L_FilterStatus= new JLabel("Port Filter Status"); 
  JLabel L_FilterStatusBox= new JLabel("DIABLED (ALL PORTS)");
  ...
  public void BuildGUI(){
      ...
      B_STOP.setBounds(200, 388, 75, 20);
      //----------------------------------------------
     ...
     //--------------------------------------------------   
      ...
      B_EXIT.setMargin(new Insets(0,0,0,0));
        ...
        B_LOAD.setBounds(180, 400, 75, 25);
         //-------------------------------------------
...
RB_Port_Special.setBounds(400,330,90,20);
...
RB_Port_SSL.setBounds(420,340,100,23);
...
RB_Port_Special.setBounds(660,320,90,25);
...
RB_Port_SQL.setBounds(660,400,90,25);
...
L_FilterStatusBox.setBorder(BorderFactory.createLineBorder(new Color(255,51,0)));
...
TF_SelectInterface.setBounds(3,360,70,20);
...
TF_SpecialPort.setBounds(30,360,70,20);
    ...
    L_FilterStatusBox.setText("Disabled (All ports)");
      ...
      public void ListNetworkInterfaces(){
            ...
            for (int i=0;i<NETWORK_INTERFACES.length;i++){
                ...
                for(int j=0;j<=NETWORK_INTERFACES.length;j++)
                {
                    TA_OUTPUT.append(Integer.toHexString(R[j] & 0xff) + ":");
                }
     ...
     +"------------------------------------------------\n\n");
      ...
      public static void SaveCaptureData()
      {
          ...
          { JOptionPane.showMessageDialog(null, "error: couldn't save the data");
      }
      }
      public static void LoadCaptureData()
      {
           ...
           try
           {
               ...
               JOptionPane.showMessageDialog(null,"Data loaded successsfully");
